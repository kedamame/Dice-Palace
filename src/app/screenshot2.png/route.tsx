...
// Screenshot 2: Win result screen
      ...
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', background: BG, fontFamily: 'sans-serif' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', background: BG2, borderBottom: `1px solid ${BORDER}`, padding: '32px 40px 24px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 50 }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
              ...
              <div style={{ fontSize: 52, color: '#e8b570', fontWeight: 700, fontFamily: 'serif', display: 'flex' }}>1,100</div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
              ...
              <div style={{ fontSize: 52, color: '#e8b570', fontWeight: 700, fontFamily: 'serif', display: 'flex' }}>4</div>
            </div>
          </div>
        </div>

        {/* Dice - winning roll showing BIG (sum 14) */}
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', background: BG2, borderBottom: `1px solid ${BORDER}`, padding: '40px 40px 28px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 12 }}>
            ...
            <div style={{ fontSize: 48, color: SECONDARY, fontWeight: 700, fontFamily: 'serif', display: 'flex' }}>14</div>
          </div>
        </div>

        {/* Win banner */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '24px 40px', background: 'rgba(125,200,122,0.1)', borderBottom: '1px solid rgba(125,200,122,0.25)' }}>
          <div style={{ fontSize: 26, color: SECONDARY, letterSpacing: 4, display: 'flex' }}>Sum 14 - BIG</div>
          <div style={{ fontSize: 48, color: '#7dc87a', fontWeight: 700, fontFamily: 'serif', display: 'flex' }}>+100</div>
        </div>

        {/* Betting area - sum tab selected */}
              ...
              {[10, 25, 50, 100, 500, 'MAX'].map((amt, i) => (
                <div
                  ...
                  style={{
                    ...
                    fontSize: 26,
                    fontFamily: 'serif',
                    color: i === 3 ? GOLD : SECONDARY,
                    background: CARD,
                    border: `1px solid ${i === 3 ? GOLD : BORDER}`,
                    borderRadius: 4,
                    display: 'flex',
                  }}
                >
